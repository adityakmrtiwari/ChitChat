...
const Footer = () => (
  <motion.footer 
    ...
    className="w-full bg-black/90 backdrop-blur-xl border-t border-white/20 text-white py-3 sm:py-4 px-4 sm:px-6 flex flex-col sm:flex-row justify-between items-center mt-auto relative z-10"
  >
